...
type GameDataApiResponse = {success: true, data:Record<string, GameInfo | null>} | {success: false, data: ApiErrorData, error?:unknown}

export default async function fetchGameData(appId: string, apiKey:string): Promise<GameDataApiResponse> {
    try {
